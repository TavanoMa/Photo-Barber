      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          <p className="text-white/70 mb-8">
            ...
            decide com você antes da máquina encostar no cabelo.
          </p>
          ...
          <a
            href="#pricing"
            className="inline-block mt-10 bg-gradient-to-r from-purple-500 to-fuchsia-600 px-7 py-3 rounded-full font-semibold hover:opacity-90 transition shadow-lg shadow-purple-500/20"
          >
            Ver planos →
          </a>
          */}
          ...
          <div className="relative bg-[#0c0c14]/90 backdrop-blur border border-white/10 rounded-3xl p-6 shadow-2xl">
            ...
            <div className="grid grid-cols-2 gap-5 mb-6">
              ...
              <div className="bg-gradient-to-br from-purple-500/40 to-fuchsia-600/40 rounded-2xl h-64 flex flex-col items-center justify-center text-white text-sm border border-purple-400/30 shadow-lg shadow-purple-600/20">
                <span className="text-xs text-purple-200 mb-2">
                  DEPOIS
                </span>
                Prévia do corte
              </div>
