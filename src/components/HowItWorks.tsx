      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-white/60">
            {isLanding
              ? "Teste o Simulador de Cortes"
              : "Simulador de Cortes"}
          </h1>

          <p className="text-white/60 max-w-2xl mx-auto text-lg">
            {isLanding
              ? "Faça um teste grátis e veja como seu próximo corte pode ficar antes mesmo de ir para a cadeira."
            ...
            {isLanding ? (
              <>
                <Step
                  ...
                  description="Tire uma foto de frente e outra de lado com boa iluminação."
                />

                <Step
                  number="2"
                  title="✂️ Escolha um corte"
                  description="Teste gratuitamente estilos populares como Buzz Cut e Samurai."
                />

                <Step
                  number="3"
                  title="✨ Veja o resultado"
                  description="Nossa IA cria uma simulação hiper-realista em segundos."
                />
              </>
            ) : (
              <>
                <Step
                  ...
                  description="Tire uma foto de frente e outra de perfil do cliente com boa iluminação."
                />

                <Step
                  number="2"
                  title="✂️ Escolha o estilo"
                  description="Navegue pelo catálogo e adicione cortes e barbas para testar."
                />

                <Step
                  number="3"
                  title="✨ Veja a mágica"
                  description="Nossa IA gera prévias hiper-realistas para o cliente aprovar na hora."
                />
              </>
            )}
          </div>
